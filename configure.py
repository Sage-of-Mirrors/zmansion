...
Adapted for zmansion from https://github.com/SeekyCt/spm-decomp/blob/master/configure.py
"""
...
# Check CW was added
assert os.path.exists("tools/mwcc_compiler/1.1/mwcceppc.exe") and \
       os.path.exists("tools/mwcc_compiler/1.1/mwldeppc.exe"), \
       "Error: Codewarrior not found in tools/mwcc_compiler/1.1"
...
assert dol_hash == bytes.fromhex("77D49225E7D28B9777916CDBE5809345C570ECBC"), \
