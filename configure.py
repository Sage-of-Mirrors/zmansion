...
LIBS = [
    {
        ...
        "objects": [
            ...
            ["extabindex_", False],
            ["text", False],
            ["src/GalleryStuff", False],
            ["src/EntityManagerUtilStuff", False],
            ["src/AnimKeyMetadata", False],
            ["JSystem/JSystem", False],
            ["Dolphin/sdk", False],
            ["Dolphin/TRK_MINNOW_DOLPHIN/mainloop", False],
            ["Dolphin/TRK_MINNOW_DOLPHIN/nubevent", False],
            ["Dolphin/TRK_MINNOW_DOLPHIN/nubinit", False],
            ["Dolphin/TRK_MINNOW_DOLPHIN/msg", False],
            ["Dolphin/TRK_MINNOW_DOLPHIN/msgbuf", False],
            ["Dolphin/TRK_MINNOW_DOLPHIN/usr_put", False],
            ["Dolphin/TRK_MINNOW_DOLPHIN/dispatch", False],
            ["Dolphin/TRK_MINNOW_DOLPHIN/msghndlr", False],
            ["Dolphin/TRK_MINNOW_DOLPHIN/support", False],
            ["Dolphin/TRK_MINNOW_DOLPHIN/mutex_TRK", False],
            ["Dolphin/TRK_MINNOW_DOLPHIN/notify", False],
            ["Dolphin/TRK_MINNOW_DOLPHIN/flush_cache", False],
            ["Dolphin/TRK_MINNOW_DOLPHIN/mem_TRK", False],
            ["Dolphin/TRK_MINNOW_DOLPHIN/targimpl", False],
            ["Dolphin/TRK_MINNOW_DOLPHIN/dolphin_trk", False],
            ["Dolphin/TRK_MINNOW_DOLPHIN/mpc_7xx_603e", False],
            ["Dolphin/TRK_MINNOW_DOLPHIN/main_TRK", False],
